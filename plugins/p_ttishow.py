...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('📌 Cᴏɴᴛᴀᴄᴛ Sᴜᴘᴘᴏʀᴛ 📌', url=f'https://t.me/TMZ_ADMIN_BOT')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton("🍁 Hᴏᴡ Tᴏ Uꜱᴇ 🍁", url="https://t.me/ItachiUchiha_Filter_Bot?start=help")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
                  InlineKeyboardButton("📌 Cᴏɴᴛᴀᴄᴛ Sᴜᴘᴘᴏʀᴛ 📌", url="https://t.me/TMZ_ADMIN_BOT")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
